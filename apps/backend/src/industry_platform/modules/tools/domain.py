...
TOOL_SOURCE_LOCATOR_SCHEMES: Final = frozenset({"fixture", "https", "sec", "sql"})
...
# Five annual DuPont calculations require at most thirty distinct raw inputs.
MAX_TOOL_SOURCES: Final = 32
