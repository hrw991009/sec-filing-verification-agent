...
完整门禁以根 [README 统一验证](../../README.md#统一验证)为准。Day 4 的本地全绿、提交/push、最终功能分支 CI、`main` 合并提交 CI、正式 Trace/Eval/DoD 与项目所有者授权收口均已完成；步骤 1～5 与 D4-01～D4-07 统一为 `complete`，允许进入 Day 5。核心 Domain/Application/Research workflow 85% 覆盖率债务必须保留登记，并在 Day 7 总门禁前补到 90%。
