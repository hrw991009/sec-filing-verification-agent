...
| D8-08 | Verified/Monitor Workbench 与 A2/A3/A4 | NEW | Verifier issues、revise diff、Approval、Monitor、Case、两个 accession/Evidence | 正式 API/Event/Trace 驱动、fault/security report 和净收益决定 | `thin_slice` | `complete` |
